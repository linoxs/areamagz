...
<div id="wrapper">
  ...
  <a href="<?php echo url::site('blog/write_new?auth_id='.$author->id); ?>">Write new entry</a>
    ...
    <div class="data-wrapper">
      ...
      <table class="data-table">
        ...
        <tr>
          ...
          <td class="<?php echo $class; ?>" width="38%"><?php echo text::limit_words(stripslashes($entry->title), 10, '...'); ?></td>
          ...
          <td class="<?php echo $class; ?>" width="7%">
            <a href="<?php echo url::site('blog/edit/'.$entry->id.'?auth_id='.$author->id); ?>"><img src="<?php echo url::base().'/'.Kohana::config('core.image_url'); ?>icons/database_edit.gif" rel="Edit this record" title="Edit this record" class="icon"/></a> |
...
$(document).ready(function(){
  $('.del-confirm').click(function(){
    ...
    jConfirm('Are you sure delete this entry?', 'Delete entry', function(val){
      if (val == true)
      {
        window.location.href = '<?php echo url::site('blog/delete'); ?>/'+ id +'?auth_id=<?php echo $author->id; ?>';
      }
      else
      {
        return false;
