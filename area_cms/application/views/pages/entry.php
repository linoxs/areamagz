...
<div id="wrapper">
  ...
  <form method="post" action="<?php echo url::base(); ?>new_entry/save/<?php echo @$entry->id; ?>" id="newentry_form" enctype="multipart/form-data">
  <table class="inputForm">
    ...
    <tr>
      <td>&nbsp;</td>
      <td>
        <img class="userpic" src="<?php echo url::base().Kohana::config('core.entry_image_folder').$entry->thumb_image; ?>" style=""/>
        <br/>
    ...
    <tr>
      ...
      <td>
        <select name="category" class="input-select">
          ...
          <?php $selected = $category->id == @$entry->category_id ? 'selected' : ''; ?>
            <option value="<?php echo $category->id; ?>" <?php echo $selected; ?>><?php echo $category->label; ?></option>
          <?php endforeach; ?>
        </select>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <input type="text" name="date" id="date" class="input-text-short" value="<?php echo substr($entry->created_at, 0, 10); ?>" />
