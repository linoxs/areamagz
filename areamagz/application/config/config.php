 ...
 */
$config['site_domain']  = '192.168.11.42/areamagz/trunk/';
$config['img_url']      = 'media/images/';

// DINAMIC SYSTEM FOLDER
$config['entry_image_folder'] = '192.168.11.42/area_cms/media/data/entry_images/';
$config['event_image_folder'] = '192.168.11.42/area_cms/media/data/event_images/';
$config['blog_image_folder']  = '192.168.11.42/area_cms/media/data/blog_images/';
$config['gallery_folder']     = '192.168.11.42/area_cms/media/data/gallery/';
